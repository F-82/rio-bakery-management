  ...
  return (
    <div className="flex flex-col gap-6 p-4 sm:p-6">
      ...
      <div className="hidden print:block">
        <h1 className="text-h1 text-ink">{t("Sales report")}</h1>
      ...
      <div className="flex flex-col gap-2">
        <span className="text-micro text-ink-2">{t("Revenue")}</span>
      ...
      <div className="grid grid-cols-2 gap-4">
        <StatCard icon={Receipt} label={t("Orders")} value={String(summary.totalOrders)} />
        <StatCard icon={Wallet} label={t("Completed")} value={String(summary.completedOrders)} />
      </div>
