  ...
  return (
    <div className="flex flex-col gap-6 p-4 sm:p-6">
      ...
      <div className="flex flex-col gap-2">
        <span className="text-micro text-ink-2">Total income</span>
      ...
      <div className="grid grid-cols-2 gap-4">
        <StatCard icon={Receipt} label="Total orders" value={String(summary.totalOrders)} />
        <StatCard icon={Wallet} label="Total expenses" value={formatLKR(summary.totalExpenses)} />
      </div>

      <div className="flex flex-col gap-2 rounded-card bg-surface p-6">
        <IconChip icon={CalendarDays} />
        <span className="text-micro text-ink-2">Booking revenue</span>
      ...
      <div className="flex flex-col gap-3 rounded-card bg-surface p-6">
        ...
        <span className="text-micro text-ink-2">Net profit</span>
      ...
      <div className="flex flex-col gap-4 rounded-card bg-surface p-6">
        <span className="text-micro text-ink-2">Revenue by day</span>
